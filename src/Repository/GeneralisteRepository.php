...
/**
 * @extends ServiceEntityRepository<Generaliste>
 *
 ...
 */
class GeneralisteRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(Generaliste $entity, bool $flush = false): void
    {
    ...
    public function remove(Generaliste $entity, bool $flush = false): void
    {
